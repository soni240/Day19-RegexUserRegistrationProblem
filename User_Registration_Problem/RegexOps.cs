...
namespace User_Registration_Problem
{
    public class RegexOps
    {
        ...
        public static string RegexRule = "^([A-Za-z0-9]{3,20})([.+-_*][A-Za-z0-9]{1,10})*([@][A-Za-z0-9]{1,5})+[.][A-Za-z]{2,3}([.][A-Za-z]{2,3})?$";//Validate Email_ID
        ...
        public bool ValidateUserName(string Sample_Mail_ID)
        {
            {
                return Regex.IsMatch(Sample_Mail_ID, RegexRule);
